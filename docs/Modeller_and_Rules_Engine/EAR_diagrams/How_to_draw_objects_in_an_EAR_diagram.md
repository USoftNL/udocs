...
To draw an EAR diagram, you first need to set it up. This works very differently between USoft 10 and USoft 11. For details on this, please go to the [EAR diagrams](/Modeller_and_Rules_Engine/EAR_diagrams/EAR_diagrams.md) article.
