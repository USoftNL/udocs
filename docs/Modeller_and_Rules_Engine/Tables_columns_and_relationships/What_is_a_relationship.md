...
For help on mapping cardinality to USoft Tables, Columns and Relationships, click [here](/docs/Modeller_and_Rules_Engine/Tables_columns_and_relationships/Cardinality_in_relationships.md).
