...
This article is about the **input()** function of the [udb object](/Web_and_app_UIs/UDB_udb).
...
$.udb.input() is similar to [$.udb.dialog()](/Web_and_app_UIs/UDB_udb/udbdialog.md) but more complex:
