...
This article is about the **label()** function of the [ColsMeta object](/Web_and_app_UIs/UDB_ColsMeta).
...
This function is now obsolete. Prefer [ColsMeta.prompt()](/Web_and_app_UIs/UDB_ColsMeta/ColsMetaprompt.md).
