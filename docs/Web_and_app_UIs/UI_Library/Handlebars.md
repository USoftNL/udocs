...
This article covers **handlebars** as a way of getting USoft UI controls from jQuery expressions. This is part of the [UI Library](/Web_and_app_UIs/UI_Library).
