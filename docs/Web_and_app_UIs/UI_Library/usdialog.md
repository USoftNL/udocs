...
This article covers the **usdialog()** function as part of the [UI Library](/Web_and_app_UIs/UI_Library).
...
Prefer [$.udb.dialog()](/Web_and_app_UIs/UDB_udb/udbdialog.md) if you want to produce a simple interactive message.
