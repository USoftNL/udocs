...
Blend directives are listed by name and by subject in [Blend directives](/Repositories/Blend_directives).
...
Blend functions are listed by name and by subject in [Blend functions](/Repositories/Blend_functions).
...
More explanation on RDMI is [What is an RDMI component](/Extensions/RDMI_Components/What_is_an_RDMI_component_and_how_do_you_create_one.md).

### The USXSL internal component

The [USXSL internal component](/Extensions/USXSL_internal_component/USXSL_internal_component.md) is an XSLT 1.0 processor written in Xalan/C++ that allows you to apply XSLT 1.0 transformations to XML data sets.
...
The [USCSXSL internal component](/Extensions/USCSXSL_internal_component) is an XSLT 1.0 processor written in .NET/C# that allows you to apply XSLT 1.0 transformations to XML data sets.
