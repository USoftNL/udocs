...
You can easily construct complex decision trees with repeated branching, because in the Yes Action and No Action scripts you can call sub-decisions using [ActionDecision()](/Task_flow/Action_Language_reference_A-C/ActionDecision.md).
